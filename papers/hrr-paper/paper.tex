...
\begin{document}
	...
	\begin{abstract}
		...
		their corresponding inverse for decoding, which is necessary
		...
		We also evaluate our memories in three different robotics tasks:
		mapping and recall of an area by a mobile agent, top-down visual
